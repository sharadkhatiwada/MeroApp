...
Route::prefix('console')->group(function () {
    ...
    //Route::post('/contact-book/delete/{id}','Admin\ContactController@destroy')->name('contact.destroyed');
    Route::post('/contact-book/delete','Admin\ContactController@destroy')->name('contact.destroyed');
